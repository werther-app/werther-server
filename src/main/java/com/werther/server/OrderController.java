...
public class OrderController {
            ...
            if (orderInQueue != null) {
                ...
                if (orderCompleted == null) {
                    ...
                    if (result == null) {
                        ...
                        registerOrder(db, clientOid, orderCompleted.get("url", String.class));
                        throw new ResponseStatusException(
                                HttpStatus.ACCEPTED, "Working");
                    } else {
    ...
    private static ObjectId selectOnlineWorker(MongoCollection<Document> workers) {
        ObjectId oid = ClientListener.getClients().keySet().toArray(new ObjectId[0])[0];
        return oid;
    }
    ...
    public static String registerOrder(MongoDatabase db, ObjectId client, String url) {
        MongoCollection<Document> queue = db.getCollection("ordersQueue");
        ...
        if (isQueueEmpty) {
            ...
            if (workerOid != null) {
                ...
                // send order
                ClientListener.sendOrder(workerOid, client, url);
            }
        }

        return orderDocument.get("_id", String.class);
    }
